...
// element
const quote = document.querySelector(".quote-widget__quote");
const author = document.querySelector(".quote-widget__author");

function randomQuote() {
  const todayQoute = Math.floor(Math.random() * quotes.length);
  quote.innerText = quotes[todayQoute].quote;
  author.innerText = quotes[todayQoute].author;
}
